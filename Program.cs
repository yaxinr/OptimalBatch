...
namespace OptimalBatch
{
    class Program
    {
        static void Main()
        {
            ...
            var optimalBatches = OptimalBatchStatic.GetOptimalBatches(reqs, 122, 30, 29);
        ...
        private static Requirement[] SeedSmallLastBatch()
        {
            ...
            new Requirement(10, new DateTime(2021, 5, 28) ),
            new Requirement(12, new DateTime(2021, 5, 28) ),
            new Requirement(12, new DateTime(2021, 5, 28) ),
            new Requirement(48, new DateTime(2021, 6,14) ),
            };
